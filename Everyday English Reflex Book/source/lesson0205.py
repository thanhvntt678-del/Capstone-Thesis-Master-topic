...
LESSON_0205 = {
    ...
    'cefr': 'A0 / Pre-A1',
    'domain': 'Shopping',
    'en_title': 'Asking and Answering Very Simple Questions About a Misunderstanding or Problem Involving Shopping & Payments',
    'vi_title': 'Giao tiếp nền tảng: shopping & payments — a misunderstanding or problem involving shopping & payments',
    'intro_en': (
        "Ms Lan often shops at the small corner store where Ms Perdita works, and once in a while a small "
        "mix-up happens with the bill or the order. Across many everyday moments -- a receipt showing two "
        "coffees instead of one, being charged for a medium coffee instead of a small one, a loyalty card "
        "discount not being applied, too much change being given back, a grocery bag with someone else's "
        "items mixed in, a tea box scanning at a higher price than the shelf tag, a candle box holding the "
        "wrong colour, a receipt billing for more apples than were bought, a coupon for free bread not "
        "applying to the bill, a detergent bottle in the wrong size, a charge appearing twice for the same "
        "umbrella, a store credit showing the wrong amount, a yogurt cup in the wrong flavour, a reusable "
        "bag discount not being scanned, a banana weight looking higher than what was bought, a gift "
        "receipt missing from a wrapped present, an extra service charge added by mistake, a warranty card "
        "missing from a new kettle, two shopping bags being swapped with another customer, a notebook price "
        "not matching its shelf sticker, a soap in the wrong scent, a sale item charged at full price, a "
        "missing item from an online pickup order, a tea box holding the wrong kind of tea bags, a card "
        "being charged twice because of a till glitch, a flower pot delivered in the wrong size, a paint "
        "can label showing the wrong colour code, a toy box missing its included batteries, a recipe card "
        "not matching a meal kit's ingredients, a return policy explained differently from the sign, an old "
        "sale price still being charged after the sale ended, a price tag showing the wrong currency "
        "symbol, a loyalty card not being stamped for today's purchase, a rice bag delivered in the wrong "
        "weight, a regular customer discount not being applied, two receipts printing for a single "
        "purchase, a candle labelled unscented that actually has a scent, a foreign coin mixed into the "
        "change, a free sample missing from a purchase, a bread loaf wearing yesterday's date sticker, a "
        "self-checkout screen charging for a bag that was never taken, and finally why being able to sort "
        "out a small misunderstanding or problem with shopping and payments matters so much -- one of them "
        "politely points out the small problem, and the other checks, explains, or fixes it warmly each "
        "time."
    ),
    'intro_vi': (
        "Chị Lan hay ghé mua đồ ở cửa hàng nhỏ nơi chị Perdita làm việc, và thỉnh thoảng có một chút nhầm "
        "lẫn nhỏ về hóa đơn hoặc đơn hàng. Qua nhiều khoảnh khắc đời thường -- hóa đơn ghi hai ly cà phê "
        "thay vì một, bị tính tiền ly cà phê cỡ vừa thay vì cỡ nhỏ, giảm giá thẻ thành viên chưa được áp "
        "dụng, được thối tiền dư, túi đồ tạp hóa lẫn đồ của người khác, hộp trà quét mã tính giá cao hơn "
        "nhãn trên kệ, hộp nến bên trong là màu khác, hóa đơn tính nhiều táo hơn số đã mua, phiếu giảm giá "
        "bánh mì miễn phí không được áp dụng, chai nước giặt bị sai cỡ, hóa đơn tính tiền hai lần cho cùng "
        "một cây dù, số dư thẻ tích điểm ghi sai, hộp sữa chua sai vị, giảm giá túi tái sử dụng chưa được "
        "quét, cân chuối ghi nặng hơn số đã mua, thiếu phiếu quà tặng trong gói quà đã gói sẵn, phụ phí dịch "
        "vụ bị cộng thêm nhầm, thiếu thẻ bảo hành trong hộp ấm đun nước mới, hai túi đồ bị lẫn với khách "
        "khác, giá cuốn sổ tay không khớp với nhãn trên kệ, xà phòng sai mùi hương, món hàng giảm giá bị "
        "tính giá gốc, thiếu một món trong đơn đặt hàng online tới lấy, hộp trà bên trong là loại trà khác, "
        "thẻ bị tính tiền hai lần vì máy tính tiền trục trặc, chậu hoa giao sai cỡ, nhãn lon sơn ghi sai mã "
        "màu, hộp đồ chơi thiếu pin đi kèm, thẻ công thức không khớp với nguyên liệu trong hộp bữa ăn, "
        "chính sách đổi trả được giải thích khác với bảng thông báo, giá khuyến mãi cũ vẫn bị tính sau khi "
        "hết đợt giảm giá, nhãn giá ghi sai ký hiệu tiền tệ, thẻ tích điểm chưa được đóng dấu cho lần mua "
        "hôm nay, bao gạo giao sai trọng lượng, giảm giá khách quen chưa được áp dụng, hai hóa đơn bị in ra "
        "cho một lần mua, hộp nến ghi không mùi nhưng thật ra có mùi, một đồng xu nước ngoài lẫn trong tiền "
        "thối, thiếu mẫu dùng thử miễn phí đi kèm, ổ bánh mì dán nhãn ngày hôm qua, màn hình tự thanh toán "
        "tính tiền một chiếc túi chưa hề lấy, và cuối cùng là vì sao có thể giải quyết một hiểu lầm hoặc vấn "
        "đề nhỏ về mua sắm và thanh toán lại quan trọng đến thế -- một người lịch sự chỉ ra vấn đề nhỏ, và "
        "người kia kiểm tra, giải thích, hoặc sửa lại một cách ấm áp mỗi lần."
    ),
    'turns': [
        # 1
        ...
        ("Ms Lan", "Let me check the cup — yes, this does feel bigger than usual.", "Để tôi xem cái ly — đúng rồi, cái này to hơn bình thường."),
        ("Ms Perdita", "Sorry about that, let me make you a small one right away.", "Tôi xin lỗi, để tôi pha ngay một ly cỡ nhỏ cho chị."),
        # 3
        ("Ms Lan", "Sorry, my loyalty card discount is not showing on this receipt.", "Xin lỗi, giảm giá thẻ thành viên của tôi không có trên hóa đơn này."),
        ("Ms Perdita", "Let me check — I forgot to scan your card, I am sorry.", "Để tôi kiểm tra — tôi quên quét thẻ của chị, tôi xin lỗi."),
        ("Ms Lan", "Perfect, that makes sense now.", "Tuyệt vời, vậy là hợp lý rồi."),
        # 4
        ("Ms Perdita", "Wait, I think I gave you too much change just now.", "Khoan đã, hình như tôi vừa thối tiền dư cho chị."),
        ("Ms Lan", "Let me count it — yes, this does look a little extra.", "Để tôi đếm lại — đúng vậy, có vẻ hơi dư một chút."),
        ("Ms Perdita", "Thank you for noticing, could I take back this small coin?", "Cảm ơn chị đã để ý, cho tôi lấy lại đồng xu nhỏ này nhé?"),
        # 5
        ("Ms Lan", "Excuse me, this bag has a jar of honey that is not mine.", "Xin lỗi, túi này có một hũ mật ong không phải của tôi."),
        ("Ms Perdita", "Let me look — this must belong to the customer before you.", "Để tôi xem — chắc là của khách trước chị rồi."),
        ("Ms Lan", "Wonderful, thank you for the quick fix.", "Tuyệt quá, cảm ơn chị đã sửa nhanh vậy."),
        # 6
        ("Ms Perdita", "Excuse me, I think your tea box scanned at the wrong price.", "Xin lỗi chị, tôi nghĩ hộp trà của chị bị quét sai giá."),
        ("Ms Lan", "Thank you for checking, the total did seem a little high.", "Cảm ơn chị đã kiểm tra, tôi cũng thấy tổng tiền hơi cao."),
        ...
        ("Ms Perdita", "Let me look — yes, I will remove that extra charge.", "Để tôi xem — đúng vậy, tôi sẽ xóa khoản tính dư đó."),
        ("Ms Lan", "Thank you, I feel much better now.", "Cảm ơn chị, giờ tôi thấy nhẹ nhõm hơn nhiều."),
        # 12
        ("Ms Perdita", "Excuse me, your store credit was printed with the wrong amount.", "Xin lỗi chị, số dư thẻ tích điểm của chị được in sai."),
        ("Ms Lan", "Thank you for noticing, that number did look a little low.", "Cảm ơn chị đã để ý, con số đó tôi thấy cũng hơi thấp."),
        ...
        ("Ms Perdita", "Let me print one now and slip it under the ribbon.", "Để tôi in một phiếu ngay và cài dưới sợi ruy băng."),
        ("Ms Lan", "Perfect, thank you for double-checking that.", "Tuyệt vời, cảm ơn chị đã kiểm tra kỹ lại giúp."),
        # 17
        ("Ms Perdita", "Excuse me, an extra service charge was added to your bill by mistake.", "Xin lỗi chị, có một khoản phụ phí dịch vụ bị cộng nhầm vào hóa đơn."),
        ("Ms Lan", "Let me look — yes, I did not see that line explained anywhere.", "Để tôi xem — đúng vậy, tôi không thấy dòng đó được giải thích ở đâu cả."),
        ("Ms Perdita", "Thank you for your patience, I will remove that charge now.", "Cảm ơn chị đã kiên nhẫn, tôi sẽ xóa khoản phí đó ngay."),
        # 18
        ("Ms Perdita", "Wait, I think the warranty card is missing from your new kettle.", "Khoan đã, hình như thẻ bảo hành bị thiếu trong hộp ấm đun nước mới của chị."),
        ("Ms Lan", "Let me open the box — yes, there is no card inside.", "Để tôi mở hộp — đúng vậy, không có thẻ bên trong."),
        ("Ms Perdita", "Ah, now that makes sense, let me find you one from the back.", "À, giờ rõ rồi, để tôi tìm một thẻ ở phía sau cho chị."),
        # 19
        ("Ms Perdita", "Wait, I think your bag got swapped with another customer's by mistake.", "Khoan đã, hình như túi của chị bị lẫn với túi của khách khác."),
        ("Ms Lan", "Let me check — yes, this bag has bread rolls I never bought.", "Để tôi kiểm tra — đúng vậy, túi này có bánh mì cuộn mà tôi chưa hề mua."),
        ...
        ("Ms Perdita", "Let me open another box — sorry, they got mixed up in the back.", "Để tôi mở một hộp khác — tôi xin lỗi, các hộp bị lẫn lộn ở phía sau."),
        ("Ms Lan", "Good, thank you for the quick correction.", "Tốt, cảm ơn chị đã sửa lại nhanh chóng."),
        # 25
        ("Ms Perdita", "Excuse me, I think the till charged your card twice for this purchase.", "Xin lỗi chị, tôi nghĩ máy tính tiền đã tính thẻ của chị hai lần cho lần mua này."),
        ("Ms Lan", "Let me check my phone — yes, there are two charges listed here.", "Để tôi kiểm tra điện thoại — đúng vậy, ở đây có hai khoản tính tiền."),
        ...
        ("Ms Lan", "Let me shake it — yes, it does feel quite light.", "Để tôi lắc thử — đúng vậy, nó khá nhẹ."),
        ...
        ("Ms Lan", "Thank you for catching that, the sign by the door says thirty too.", "Cảm ơn chị đã phát hiện, bảng thông báo cạnh cửa cũng ghi ba mươi ngày."),
        ...
        ("Ms Lan", "Let me look — yes, I have two copies, but only one charge on my card.", "Để tôi xem — đúng vậy, tôi có hai bản đây, nhưng thẻ chỉ bị tính tiền một lần."),
        ...
        ("Ms Lan", "Let me look — yes, the date says yesterday, though it still smells fresh.", "Để tôi xem — đúng vậy, ngày ghi là hôm qua, dù nó vẫn có mùi thơm mới."),
        ("Ms Perdita", "Let me give you a fresh loaf from today's batch instead.", "Để tôi đưa cho chị ổ bánh mới của hôm nay thay vào."),
        # 41
        ("Ms Lan", "Excuse me, the self-checkout screen charged me for a bag I did not take.", "Xin lỗi, màn hình tự thanh toán tính tiền một chiếc túi mà tôi không hề lấy."),
